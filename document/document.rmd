...
我们的报告的不足之处之一是将不同国家的结论组合的时候，没有考虑到国家和国家的权重问题. 例如，在计算投资额时，可以考虑除去国家的经济总量，以反映中国投资占比占该国家GDP的比例. 而且对于不同国家所受影响的大小，只有数值和定性分析，没有更深入的定量分析. 此外，在计算投资额的相关数据时没有剔除填补数据所造成的失真.
