...
include_graphics("resources/黑山_ci_sc.svg")
```
...
include_graphics("resources/蒙古_data_raw.svg")
```
...
```{r include=FALSE}
ci_csv <- read_csv("../results/IMR/ci.csv")
cii_csv <- read_csv("../results/investment/ci.csv")
```
