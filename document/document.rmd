...
分析一带一路的影响，就是要分析某一事件发生后，某一值的变化情况，这是经典的政策影响问题. 该值自身也存在着模型外因素导致的变化趋势，所以我们必须利用某些技术来去除这些因素的影响. 于是，我们运用双重差分和合成控制两种技术. 参见[方法$\star$](#method).
...
可见，在一带一路的参与国家中，婴儿死亡率相比预期降低（$P<0.10$）的国家共有4个，如下所示.
