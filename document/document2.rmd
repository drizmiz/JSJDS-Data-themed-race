...
我们发现，一带一路提出后，中国与一些沿线国家的投资水平有了显著增加. 同时，我们将一带一路沿线国家与中国的相互投资水平进行了可视化，可以直观反映出一带一路的成效，并对不同国家进行定性比较. 此部分有很强的政策参考价值.
...
![总效应示意图](resources/pooled_average.pdf){#model .class width=60% height=60%}
